...
# O typecheck do Next 16 passa do heap padrao do Node e o processo
# morre sem mensagem (exit 255). 4 GB da folga.
# O typecheck do Next 16 sobre este projeto passa do heap padrão do
# Node e o processo é morto sem mensagem (exit code 255). 6 GB dá
# folga numa VPS de 12 GB.
