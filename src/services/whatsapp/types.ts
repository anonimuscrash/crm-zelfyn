...
export interface WhatsAppProvider {
  ...
  /**
   * Telefone real de um chat identificado por LID, ou `null`.
   *
   * Rede de segurança para quando o payload da mensagem não traz
   * `senderPn`. `null` é resultado normal: nem todo LID é resolvível.
   */
  resolvePhone(instanceId: string, chatId: string): Promise<string | null>;
