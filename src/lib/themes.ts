...
// Azul institucional é o padrão do produto. Quem já escolheu outro
// acento mantém a escolha — o valor salvo em localStorage vence
// este default, então trocar aqui não sobrescreve preferência de
// ninguém.
export const DEFAULT_THEME: ThemeId = "operza";
...
export const THEMES: ReadonlyArray<ThemeMeta> = [
  {
    id: "operza",
    name: "Operza",
    tagline: "Azul institucional da marca.",
    swatch: "oklch(0.517 0.209 263)",
  },
  {
    id: "violet",
    name: "Violet",
