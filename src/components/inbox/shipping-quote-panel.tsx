...
export function ShippingQuotePanel({
  ...
  return (
    <CollapsibleSection
      ...
      badge={maisBarato ? formatCents(maisBarato.priceCents) : null}
      // Fechada por padrão: cotar é eventual, e aberta ela empurra o
      // histórico comercial para fora da tela.
      defaultOpen={false}
    >
