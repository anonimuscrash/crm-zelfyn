...
import { WhatsAppConnectionSettings } from '@/components/settings/whatsapp-connection-settings';
  ...
  const panel: Record<SettingsSection, ReactNode> = {
    ...
    whatsapp: (
      <div className="space-y-8">
        ...
        {/* A configuração da Meta Cloud API continua exatamente como
            estava (§34). Os dois métodos coexistem; nenhum substitui
            o outro. */}
