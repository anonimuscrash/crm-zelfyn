...
export async function POST(request: Request) {
  ...
  if (!config?.encrypted_webhook_secret) {
    ...
    // "porque ainda não configuraram" seria deixar a porta aberta
    // exatamente enquanto ninguém está olhando — e esta porta marca
    // pagamentos como recebidos.
    console.warn('[dotfy-webhook] sem segredo configurado', {
